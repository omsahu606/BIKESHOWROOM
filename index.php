...
<html>
				   ...
				   <div class="collapse navbar-collapse" id="navbar">
						<ul class="navbar-nav ml-auto">
							...
							<li class="nav-item"><?php
										if (isset($_SESSION['name'])) 
										{
											?> <li class="nav-link><a href="#"><strong><?php echo $_SESSION['name'];?></strong></a></li><?php
										}
										else
										{
											?><li data-toggle="modal" data-target="#login"><a href="#"></a></li><?php
										}
									?> 
							</li>
							<li class="nav-item"><?php
										if (isset($_SESSION['name'])) 
										{
											?> <a class="nav-link" href="logout.php">Logout</a></strong></a></li><?php
										}
										else
										{
											?><li data-toggle="modal" data-target="#login"><a href="#"></a></li><?php
				...
				<div id="carousel" class="carousel slide" data-ride="carousel">
					...
					<div class="carousel-inner">
						...
						<div class="carousel-item">
							<div class="row">
								<div class="col-md-6">
								   <div class="banner_img"><img src="images/7.jpg"></div>
								</div>
								<div class="col-md-6">
								   <div class="banner_taital_main">
									  <h1 class="banner_taital">Become Artitech of your future business</h1>
						...
						<div class="carousel-item">
							<div class="row">
								<div class="col-md-6">
								   <div class="banner_img"><img src="images/2.jpg"></div>
								</div>
								<div class="col-md-6">
								   <div class="banner_taital_main">
									  <h1 class="banner_taital">Become Artitech of your future business</h1>
    ...
    <div class="categroy_section layout_padding">
					...
					<div class="carousel-inner">
						<div class="carousel-item active">
							<div class="row">
								...
								<div class="col-md-4">
									<a href="ConsumerDisc.html">
										<div class="hover01 column">
											<figure><img src="images/img-3.png"></figure>
										</div>
									  <h3 class="materials_text">Consumer Disc</h3>
									</a>									<p class="categroy_text">words which don't look even slightly believable. If you are going to use a passage of Lorem Ipsum, you need to be sure there isn't</p>
										<div class="readmore_btn"><a href="#">Read More</a></div>
								</div>
							</div>
						</div>
                        ...
                        <div class="col-md-12">
                           <div class="customer_main">
                              <div class="customer_left">
                                 <div class="customer_img"><img src="images/team-4.jpg"></div>
                              </div>
                              <div class="customer_right">
                                 <h3 class="customer_name">Soniya</h3>
                           ...
                           <div class="customer_main_1">
                              <div class="customer_left_1">
                                 <div class="client_img1"><img src="images/team-3.jpg"></div>
                              </div>
                              <div class="customer_right_1">
                                 <h3 class="customer_name">Yash</h3>
                     ...
                     <div class="row">
                        <div class="col-md-12">
                           <div class="customer_main">
                              ...
                              <div class="customer_right">
                                 <h3 class="customer_name">Doen</h3>
                                 <p class="enim_text">It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, asIt is a long established fact that a reader will be distracted </p>
                              </div>
                           </div>
                           <div class="customer_main_1">
                              ...
                              <div class="customer_right_1">
                                 <h3 class="customer_name">Josp</h3>
                                 <p class="enim_text">It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of lette </p>
                              </div>
                           </div>
                        </div>
            ...
            <div class="row">
               <div class="col-md-8">
                  <div class="location_text">
                     <ul>
                        <li>
                           <a href="#"><span class="padding_left_10"><i class="fa fa-map-marker" aria-hidden="true"></i></span>Raipur CG<br>reader will be </a>
                        </li>
                        <li>
                           <a href="#"><span class="padding_left_10"><i class="fa fa-phone" aria-hidden="true"></i></span>(+91) 9111214400</a>
                        </li>
                        <li>
                           <a href="#"><span class="padding_left_10"><i class="fa fa-envelope" aria-hidden="true"></i></span>om@gmail.com</a>
                        </li>
                     </ul>
                  </div>
               </div>
      ...
      <div class="copyright_section">
         <div class="container">
            <p class="copyright_text">09/06/2025 All Rights Reserved. Design by OM </p>
         </div>
      </div>
